...
| 6 | `06_DeepDive_Service_and_Packaging.md` | L5 + L6 — Service & Apps | Phases 6–7 | Scheduler/API/notifier, then the Windows `.exe` (PyInstaller) and Android APK (Capacitor) packagings. |
